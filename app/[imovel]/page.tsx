...
export default async function Page({ params }: { params: { imovel: string } }) {
  ...
  return (
    <div className=" w-full  pt-[100px] flex flex-col z-[55] bg-[#f3f5fa] ">
      {property &&
        property.map((prop: PropertyType) => {
          return (
            <div className="bg-tranparent w-full h-full">
              ...
              <div className="flex flex-wrap lg:flex-nowrap gap-24  pt-[50px]">
                <div className="xl:ml-[150px] max-w-[500px] gap-4 flex flex-col px-6 w-full">
              ...
              <div className="relative w-full flex pt-[50px] justify-between max-w-7xl px-6 m-auto ">
